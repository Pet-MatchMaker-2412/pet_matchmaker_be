...
a4_f = Answer.find_or_create_by!(question: q4, text: "No")
...
a6_a = Answer.find_or_create_by!(question: q6, text: "1-3 weeks/year")
...
a9_a = Answer.find_or_create_by!(question: q9, text: "Home most of the day (remote work, retired)")
